class Facility < ApplicationRecord
  ...
  validates :name, presence: true, length: { minimum: 2, maixmum: 30 }
  validates :image_url, presence: true, length: { minimum: 2 }
  validates :brief_description, presence: true, length: { minimum: 2 }
  validates :detailed_description, presence: true, length: { minimum: 2 }
